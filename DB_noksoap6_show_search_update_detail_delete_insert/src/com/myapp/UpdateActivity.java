...
//import com.myapp.InsertActivity.ThaiUtil;
...
public class UpdateActivity extends Activity {
    ...
    public void showInfo()
    {
    	...
    	String url = "http://192.168.1.5/detailMember.php";
    ...
    public boolean SaveData()
    {
        ...
        final EditText txtTel = (EditText)findViewById(R.id.txtTel); 
    		...
    		if(txtTel.getText().length() == 0)
    		{
     		...
     		String url = "http://192.168.1.5/updateData.php";
     				List<NameValuePair> params = new ArrayList<NameValuePair>();
            params.add(new BasicNameValuePair("sMemberID", ThaiUtil.ASCII2Unicode(txtMemberID.getText().toString())  ));
