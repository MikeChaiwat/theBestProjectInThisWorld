...
public class MainActivity extends Activity {
    ...
    public void ShowData()
    {
		...
		String url = "http://192.168.1.9/showAllData.php";
    ...
    // onCreateContextMenu ทำงานตอนเปิดโปรแกรม เพื่อวนลูปใส่ menu ในแต่ละ ข้อมูลที่ดึงออกมาโชว์หน้าจอ เมื่อคลิก
    //  ที่ข้อมูลจึงจะแสดง  menu  ออกมา
  public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
      // สั่งให้เมนู มีไอคอนตรงหัว
		menu.setHeaderIcon(android.R.drawable.btn_star_big_on);
		// สั่งให้เมนู มี ข้อความ Command ตรงหัว
		menu.setHeaderTitle("Command");
		// ให้  ตัวแปร  menuItems เก็บค่า ตัวแปรตัวอักษร
		String[] menuItems = {"View","Update","Delete"}; 
		// วนลูป ให้ menu รับค่าข้อความของ menuItems
